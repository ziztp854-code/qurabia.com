...
- Existing project tokens, components, and design documentation override the starter template and generic Tailwind integration.
- Do not generate, persist, or replace project design assets unless the current user task explicitly requests it.
